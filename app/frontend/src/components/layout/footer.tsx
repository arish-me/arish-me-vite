...
const Footer = () => {
 ...
 return (
    <footer className='bg-background/30 dark:bg-black relative mx-auto flex max-w-5xl flex-col rounded-2xl p-8 shadow-sm saturate-100 backdrop-blur-[10px] my-8'>
